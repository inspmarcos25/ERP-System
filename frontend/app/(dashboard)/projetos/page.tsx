    ...
    <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              <button 
                ...
                className="p-2 rounded-xl border border-slate-800 hover:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white cursor-pointer"
              >
                <ChevronLeft size={16} />
              </button>
              <div>
                <h1 className="text-xl font-bold text-slate-800 dark:text-white tracking-tight">{selectedProj.nome}</h1>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">{selectedProj.descricao}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-slate-800 dark:text-white text-xs font-semibold cursor-pointer"
              >
                <Plus size={15} />
              ...
              <button
                ...
                className="p-2.5 rounded-xl border border-slate-800 hover:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-indigo-400 cursor-pointer"
              ...
              <button
                ...
                className="p-2.5 rounded-xl border border-slate-800 hover:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-rose-500 cursor-pointer"
              ...
              return (
                <div key={col.id} className={`p-4 rounded-2xl border ${col.color} min-h-[60vh] flex flex-col`}>
                  <div className="flex items-center justify-between mb-4 border-b border-slate-800/40 pb-2">
                    <span className="text-xs font-semibold text-slate-800 dark:text-white tracking-wide">{col.name}</span>
                    <span className="px-2 py-0.5 rounded-full bg-slate-950 text-[10px] text-slate-500 dark:text-slate-400 font-bold">
                      {colTasks.length}
                    </span>
                  </div>
                  ...
                  <div className="space-y-3 flex-1 overflow-y-auto max-h-[55vh]">
                    {colTasks.map((t) => (
                      <div key={t.id} className="glass-panel p-3.5 rounded-xl border-slate-100 dark:border-slate-850 hover:border-slate-700 transition-all">
                        <h4 className="text-xs font-bold text-slate-800 dark:text-white mb-1.5">{t.titulo}</h4>
                        {t.descricao && <p className="text-[10px] text-slate-500 dark:text-slate-400 line-clamp-2 mb-3">{t.descricao}</p>}
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-850">
                          ...
                          <div className="flex gap-1.5">
                            ...
                            <button 
                              ...
                              className="p-1 rounded bg-slate-900 border border-slate-800 hover:border-slate-600 text-slate-500 dark:text-slate-400 hover:text-indigo-400 cursor-pointer"
                              title="Editar tarefa"
                            >
                              <Pencil size={10} />
                            </button>
                            <button 
                              ...
                              className="p-1 rounded bg-slate-900 border border-slate-800 hover:border-slate-600 text-slate-500 dark:text-slate-400 hover:text-rose-400 cursor-pointer"
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-slate-800 dark:text-white text-xs font-semibold cursor-pointer"
              >
                <Plus size={15} />
          ...
          {loading ? (
            ...
            <div className="glass-panel p-12 text-center rounded-2xl">
              ...
              <h3 className="text-sm font-semibold text-slate-800 dark:text-white">Nenhum projeto registrado</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Crie um projeto para começar a gerenciar tarefas e times.</p>
            </div>
          ) : viewMode === 'list' ? (
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-800/60 bg-slate-50 dark:bg-slate-900/40">
                      ...
                      <th className="text-center py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Progresso</th>
                      <th className="text-right py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Orçamento</th>
                      <th className="text-right py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Custo Atual</th>
                  ...
                  <tbody>
                    {projetos.map((p) => (
                      <tr
                        ...
                        className="border-b border-slate-100 dark:border-slate-800/30 hover:bg-slate-50 dark:hover:bg-slate-800/20 transition-colors cursor-pointer"
                      >
                        <td className="py-3 px-4 text-slate-800 dark:text-white font-semibold">{p.nome}</td>
                        <td className="py-3 px-4 text-slate-500 dark:text-slate-400 max-w-[250px] truncate">{p.descricao || '-'}</td>
                        ...
                        <td className="py-3 px-4 text-right text-slate-800 dark:text-white font-mono">{formatCurrency(p.custo_atual)}</td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {projetos.map((p) => (
                <div 
                  key={p.id} 
                  onClick={() => setSelectedProj(p)}
                  className="glass-panel p-5 rounded-2xl border-slate-200 dark:border-slate-800/80 cursor-pointer hover:border-indigo-500/40 transition-all duration-300"
                >
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="font-bold text-slate-800 dark:text-white text-sm tracking-tight">{p.nome}</h3>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 line-clamp-2 mb-4 h-8">{p.descricao || 'Sem descrição cadastrada.'}</p>
                  ...
                  <div className="pt-3 border-t border-slate-100 dark:border-slate-850 flex items-center justify-between text-xs font-mono text-slate-500 dark:text-slate-400">
                    <span>Orçamento: <strong className="text-emerald-400">{formatCurrency(p.orcamento)}</strong></span>
                    <span>Custo: <strong className="text-slate-800 dark:text-white">{formatCurrency(p.custo_atual)}</strong></span>
                  </div>
                </div>
              ))}
            </div>
      ...
      {showAddProj && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-slate-950/85 backdrop-blur-sm">
          ...
          >
            <h3 className="text-md font-bold text-slate-800 dark:text-white mb-2">Novo Projeto</h3>
            <div className="space-y-3">
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Nome do Projeto</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Orçamento Previsto (R$)</label>
            ...
            <div className="flex justify-end gap-2 pt-3">
              <button type="button" onClick={()=>setShowAddProj(false)} className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-xs cursor-pointer">Cancelar</button>
              <button type="submit" className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-slate-800 dark:text-white text-xs cursor-pointer">Criar</button>
            </div>
          </form>
        </div>
      )}
      ...
      {showAddTask && selectedProj && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-slate-950/85 backdrop-blur-sm">
          <form 
            ...
            className="w-full max-w-sm glass-panel bg-white dark:bg-[#0B0F19] p-6 rounded-2xl shadow-2xl space-y-4"
          >
            <h3 className="text-md font-bold text-slate-800 dark:text-white mb-2">Criar Tarefa no Kanban</h3>
            <div className="space-y-3">
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Título da Tarefa</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Descrição / Detalhes</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Prioridade</label>
                ...
                <div>
                  <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Status Inicial</label>
            ...
            <div className="flex justify-end gap-2 pt-3">
              <button type="button" onClick={()=>setShowAddTask(false)} className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-xs cursor-pointer">Cancelar</button>
              <button type="submit" className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-slate-800 dark:text-white text-xs cursor-pointer">Criar</button>
            </div>
          </form>
        </div>
      ...
      {showEditProj && editProjData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-slate-950/85 backdrop-blur-sm">
          <form 
            ...
            className="w-full max-w-sm glass-panel bg-white dark:bg-[#0B0F19] p-6 rounded-2xl shadow-2xl space-y-4"
          >
            <h3 className="text-md font-bold text-slate-800 dark:text-white mb-2">Editar Projeto</h3>
            <div className="space-y-3">
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Nome do Projeto</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Orçamento (R$)</label>
            ...
            <div className="flex justify-end gap-2 pt-3">
              <button type="button" onClick={()=>{setShowEditProj(false); setEditProjData(null)}} className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-xs cursor-pointer">Cancelar</button>
      ...
      {showEditTask && editTaskData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-slate-950/85 backdrop-blur-sm">
          <form 
            ...
            className="w-full max-w-sm glass-panel bg-white dark:bg-[#0B0F19] p-6 rounded-2xl shadow-2xl space-y-4"
          >
            <h3 className="text-md font-bold text-slate-800 dark:text-white mb-2">Editar Tarefa</h3>
            <div className="space-y-3">
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Título da Tarefa</label>
            ...
            <div className="flex justify-end gap-2 pt-3">
              <button type="button" onClick={()=>{setShowEditTask(false); setEditTaskData(null)}} className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-xs cursor-pointer">Cancelar</button>
              <button type="submit" className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-slate-800 dark:text-white text-xs cursor-pointer">Salvar</button>
            </div>
          </form>
        </div>
