  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {/* Tab Selection */}
        <div className="flex bg-slate-100/50 dark:bg-slate-950/40 p-1.5 rounded-xl border border-slate-800 shrink-0">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-1.5 rounded-lg text-xs font-semibold tracking-wide transition-all cursor-pointer ${
              activeTab === 'clientes' 
                ? 'bg-indigo-600 text-slate-800 dark:text-white shadow-lg shadow-indigo-600/10' 
      ...
      {/* Control Actions Bar */}
      <div className="flex flex-col sm:flex-row items-center gap-4 bg-slate-50/50 dark:bg-slate-900/20 p-4 rounded-2xl border border-slate-200/60 dark:border-slate-800/40">
        <form onSubmit={handleSearchSubmit} className="flex-1 w-full flex gap-2">
          ...
          <button
            type="submit"
            className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 hover:bg-slate-850 text-slate-800 dark:text-white text-xs font-semibold transition-colors duration-150 cursor-pointer"
          >
            Buscar
          </button>
        </form>
        ...
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-slate-800 dark:text-white text-xs font-semibold shadow-lg shadow-indigo-600/25 cursor-pointer shrink-0 transition-all duration-150"
        >
          <Plus size={15} />
      ...
      {loading ? (
        ...
        viewMode === 'list' ? (
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-slate-800/60 bg-slate-50 dark:bg-slate-900/40">
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Nome</th>
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Email</th>
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Telefone</th>
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Cidade</th>
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Tipo</th>
                    <th className="text-right py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Crédito</th>
                    <th className="text-center py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Status</th>
                    <th className="text-center py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase w-24">Ações</th>
                  </tr>
                </thead>
                <tbody>
                  {clientes.map((c) => (
                    <tr key={c.id} className="border-b border-slate-100 dark:border-slate-800/30 hover:bg-slate-50 dark:hover:bg-slate-800/20 transition-colors">
                      <td className="py-3 px-4 text-slate-800 dark:text-white font-semibold">{c.nome}</td>
                      <td className="py-3 px-4 text-slate-500 dark:text-slate-400">{c.email || '-'}</td>
                      <td className="py-3 px-4 text-slate-500 dark:text-slate-400">{c.telefone || '-'}</td>
                      <td className="py-3 px-4 text-slate-500 dark:text-slate-400">{c.cidade ? `${c.cidade} - ${c.estado}` : '-'}</td>
                      ...
                      <td className="py-3 px-4 text-right text-slate-800 dark:text-white font-mono font-semibold">{formatCurrency(c.limite_credito)}</td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {clientes.map((c) => (
              <div key={c.id} className="glass-panel p-5 rounded-2xl flex flex-col justify-between border-slate-200 dark:border-slate-800/80">
                <div>
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="font-bold text-slate-800 dark:text-white text-sm tracking-tight truncate pr-2 flex-1" title={c.nome}>
                      {c.nome}
                    </h3>
                ...
                <div className="pt-3.5 border-t border-slate-800/60 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs font-bold text-slate-800 dark:text-white font-mono">{formatCurrency(c.limite_credito)}</p>
                  </div>
                  <span className="px-2 py-0.5 rounded-md text-[9px] font-bold tracking-wider uppercase bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
                    {c.status}
                  </span>
        ...
        viewMode === 'list' ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-slate-800/60 bg-slate-50 dark:bg-slate-900/40">
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Nome</th>
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Empresa</th>
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Email</th>
                    <th className="text-left py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Telefone</th>
                    <th className="text-right py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Valor Est.</th>
                    <th className="text-center py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Conversão</th>
                    <th className="text-center py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase">Status</th>
                    <th className="text-center py-3 px-4 text-slate-500 dark:text-slate-400 font-semibold tracking-wider uppercase w-24">Ações</th>
                  </tr>
                </thead>
                <tbody>
                  {leads.map((l) => (
                    <tr key={l.id} className="border-b border-slate-100 dark:border-slate-800/30 hover:bg-slate-50 dark:hover:bg-slate-800/20 transition-colors">
                      <td className="py-3 px-4 text-slate-800 dark:text-white font-semibold">{l.nome}</td>
                      <td className="py-3 px-4 text-slate-500 dark:text-slate-400">{l.empresa || '-'}</td>
                      <td className="py-3 px-4 text-slate-500 dark:text-slate-400">{l.email || '-'}</td>
                      <td className="py-3 px-4 text-slate-500 dark:text-slate-400">{l.telefone || '-'}</td>
                      <td className="py-3 px-4 text-right text-emerald-400 font-mono font-semibold">{formatCurrency(l.valor_estimado)}</td>
                      <td className="py-3 px-4 text-center">
                        <span className="flex items-center justify-center gap-1 text-xs font-bold text-slate-800 dark:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {leads.map((l) => (
              <div key={l.id} className="glass-panel p-5 rounded-2xl flex flex-col justify-between border-slate-200 dark:border-slate-800/80">
                <div>
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="font-bold text-slate-800 dark:text-white text-sm tracking-tight truncate pr-2 flex-1" title={l.nome}>
                      {l.nome}
                    </h3>
                    <div className="flex items-center gap-1.5 shrink-0">
                      <span className="px-2.5 py-0.5 rounded-md text-[9px] font-bold tracking-wider uppercase bg-indigo-600/20 text-indigo-400 border border-indigo-500/30">
                ...
                <div className="pt-3.5 border-t border-slate-800/60 flex items-center justify-between">
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <span className="flex items-center gap-1 text-xs font-bold text-slate-800 dark:text-white">
                      <TrendingUp size={12} className="text-cyan-400" />
                      {l.probabilidade}%
                    </span>
                  </div>
      ...
      {showAddCliente && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-slate-950/85 backdrop-blur-sm">
          <form 
            ...
            className="w-full max-w-lg glass-panel bg-white dark:bg-[#0B0F19] p-6 rounded-2xl shadow-2xl space-y-4"
          >
            <h3 className="text-md font-bold text-slate-800 dark:text-white mb-2">Cadastrar Novo Cliente</h3>
            <div className="grid grid-cols-2 gap-3">
              <div className="col-span-2">
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Nome Completo / Razão Social</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">E-mail</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Telefone</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">CPF / CNPJ</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Limite Crédito (R$)</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Cidade</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Estado (UF)</label>
            ...
            <div className="flex justify-end gap-2 pt-3">
              <button type="button" onClick={()=>setShowAddCliente(false)} className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-xs cursor-pointer">Cancelar</button>
      ...
      {showAddLead && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-slate-950/85 backdrop-blur-sm">
          ...
          >
            <h3 className="text-md font-bold text-slate-800 dark:text-white mb-2">Cadastrar Novo Lead</h3>
            <div className="space-y-3">
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Nome do Lead / Contato</label>
              ...
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Empresa</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Valor Estimado (R$)</label>
                ...
                <div>
                  <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Probabilidade (%)</label>
            ...
            <div className="flex justify-end gap-2 pt-3">
              <button type="button" onClick={()=>setShowAddLead(false)} className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-xs cursor-pointer">Cancelar</button>
              <button type="submit" className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-slate-800 dark:text-white text-xs cursor-pointer">Salvar</button>
            </div>
          </form>
        </div>
      ...
      {showEditCliente && editClientData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-slate-950/85 backdrop-blur-sm">
          <form 
            ...
            className="w-full max-w-lg glass-panel bg-white dark:bg-[#0B0F19] p-6 rounded-2xl shadow-2xl space-y-4"
          >
            <h3 className="text-md font-bold text-slate-800 dark:text-white mb-2">Editar Cliente</h3>
            <div className="grid grid-cols-2 gap-3">
              <div className="col-span-2">
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Nome Completo / Razão Social</label>
            ...
            <div className="flex justify-end gap-2 pt-3">
              <button type="button" onClick={()=>{setShowEditCliente(false); setEditClientData(null)}} className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-xs cursor-pointer">Cancelar</button>
      ...
      {showEditLead && editLeadData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-slate-950/85 backdrop-blur-sm">
          <form 
            ...
            className="w-full max-w-md glass-panel bg-white dark:bg-[#0B0F19] p-6 rounded-2xl shadow-2xl space-y-4"
          >
            <h3 className="text-md font-bold text-slate-800 dark:text-white mb-2">Editar Lead</h3>
            <div className="space-y-3">
              <div>
                <label className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Nome do Lead / Contato</label>
            ...
            <div className="flex justify-end gap-2 pt-3">
              <button type="button" onClick={()=>{setShowEditLead(false); setEditLeadData(null)}} className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-xs cursor-pointer">Cancelar</button>
              <button type="submit" className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-slate-800 dark:text-white text-xs cursor-pointer">Salvar Alterações</button>
            </div>
          </form>
        </div>
